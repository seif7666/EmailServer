...
<template>
    <div>
        ...
        <label class="file">
            <input class ="attbtn" type="file" id="file"  multiple @change = "handleUpload($event , 1)" aria-label="File browser example" />
        ...
        <div id="container">
            <form>
                ...
                <button size="2" class ="attbtn" id="btnRemove"  @click="handleUpload($event , 0)">Remove Selected attachment</button>
            </form>
        </div>
    </div>
</template>
